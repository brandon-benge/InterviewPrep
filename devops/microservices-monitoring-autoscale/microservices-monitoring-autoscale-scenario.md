...
## Summary
> Instrument with Prometheus/Grafana. Set autoscaling policies based on RPS (Requests per Second) or CPU. Use HPA (Horizontal Pod Autoscaler)/VPA (Vertical Pod Autoscaler). Include [circuit breakers](../../system-design/components/circuit-breaker.md) and throttling.
